            ...
            return (
                <li className="invoice-calc-row">
                    ...
                    <span className="invoice-calc-input-wrap invoice-calc-name">
                        ...
                        <textarea rows="1" cols="1" className="invoice-calc-input" onChange={this.updateRow.bind(this, 'name')} value={this.props.service.name} ></textarea>
                    </span>
                    <span className={"invoice-calc-input-wrap invoice-calc-count " + (isNaN(this.props.service.amount) || this.props.service.amount === '' ? 'input-error' : '')}>
                        ...
                        <textarea className="invoice-calc-input" rows="1" cols="1" onChange={this.updateRow.bind(this, 'amount')} value={this.props.service.amount}></textarea>
                    </span>
                    <span className={"invoice-calc-input-wrap invoice-calc-price-netto " + (isNaN(this.props.service.priceNetto) || this.props.service.priceNetto === '' ? 'input-error' : '')}>
                        ...
                        <textarea className="invoice-calc-input" rows="1" cols="1" onChange={this.updateRow.bind(this, 'priceNetto')} value={this.props.service.priceNetto}></textarea>
                    </span>
                    ...
                    <span className={"invoice-calc-input-wrap invoice-calc-vat " + (isNaN(this.props.service.vat.replace('%', '')) || this.props.service.vat === ''  ? 'input-error' : '')}>
                        ...
                        <textarea className="invoice-calc-input" rows="1" cols="1" onChange={this.updateRow.bind(this, 'vat')} value={this.props.service.vat}></textarea>
                    </span>
